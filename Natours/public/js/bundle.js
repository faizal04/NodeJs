...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    var popup = L.popup({
      ...
      closeOnClick: false,
      offset: [0, -20]
    }).setLatLng([lat, lng]).setContent("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).openOn(map);
  ...
  _regenerator().m(function _callee(data, type) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 2:
          res = _context.v;
          if (res.data.status === 'success') showAlert('success', "".concat(type.toUpperCase(), " Updated Successfully"));
          _context.n = 4;
          break;
...
},{"axios":"../../node_modules/axios/index.js","../../utils/catchAsync":"../../utils/catchAsync.js","./alert":"alert.js"}],"razorpay.js":[function(require,module,exports) {
"use strict";
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 3:
          ...
          (0, _alert.showAlert)('error', _t.response?.data?.message || 'Error booking tour!');
...
if (updateUserData) {
  updateUserData.addEventListener('submit', function (e) {
    ...
    formData.append('photo', document.getElementById('photo').files[0]); // console.log(formData.values);

    (0, _updateSettings.updateUserSettings)(formData, 'data');
  });
}
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            ...
            newconfirmPassword = document.querySelector('#password-confirm').value;
            _context.n = 1;
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    console.log(tourId); // Redirect to checkout page

    location.assign("/checkout/".concat(tourId));
  });
...
},{"./login":"login.js","./mapbox":"mapbox.js","./updateSettings":"updateSettings.js","./razorpay":"razorpay.js"}],"../../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
